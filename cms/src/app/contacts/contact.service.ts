...
export class ContactService {
  ...
  storeContacts(){
    ...
    this.httpClient.put("https://wdd430-cms-77739-default-rtdb.firebaseio.com/contacts.json", contacts, {
      headers: headers
    })
    .subscribe( () => {
  ...
  getContacts(){
    ...
    this.httpClient
    .get('https://wdd430-cms-77739-default-rtdb.firebaseio.com/contacts.json')
    .subscribe(
       (contacts: Contact[]) => { 
