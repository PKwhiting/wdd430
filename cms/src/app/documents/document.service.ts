...
export class DocumentService {
  ...
  storeDocuments(){
    ...
    this.httpClient.put("https://wdd430-cms-77739-default-rtdb.firebaseio.com/documents.json", documents, {
      headers: headers
    })
    .subscribe( () => {
  ...
  getDocuments(){
    ...
    this.httpClient
    .get('https://wdd430-cms-77739-default-rtdb.firebaseio.com/documents.json')
    .subscribe(
       (documents: Document[]) => { 
